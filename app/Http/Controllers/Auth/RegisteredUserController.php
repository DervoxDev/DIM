...
class RegisteredUserController extends Controller
{
    ...
    public function store(Request $request): RedirectResponse
    {
        $request->validate([
            ...
            'terms' => ['required', 'accepted'], // Add terms validation
        ], [
            'terms.required' => __('auth.You must accept the Terms and Conditions'),
            'terms.accepted' => __('auth.You must accept the Terms and Conditions'),
        ]);
