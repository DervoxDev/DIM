...
return [
    ...
    */
    ...
    // Messages de validation spécifiques pour les pays et profils
    'country_code_invalid' => 'Le pays sélectionné pour :attribute est invalide.',
    'country_code_format' => 'Le champ :attribute doit être un code pays valide de 3 caractères.',
    ...
    */
    ...
    'custom' => [
        'country_id' => [
            'size' => 'Le code pays doit contenir exactement 3 caractères.',
            'string' => 'Le code pays doit être une chaîne de caractères.',
            'invalid' => 'Le pays sélectionné est invalide.',
        ],
        'terms' => [
